...
CREATE TABLE `projects` (
  ...
  `house_type` varchar(100) DEFAULT NULL COMMENT '房型',
...
INSERT INTO `projects` (`project_id`, `name`, `developer`, `city`, `location`, `property_type`, `completion_year`, `unit_floor_parking`, `facilities`, `surroundings`, `transportation`, `mrt_station`, `house_type`, `price`, `area`, `description`) VALUES
